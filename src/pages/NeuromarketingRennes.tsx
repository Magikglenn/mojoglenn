  ...
  return (
    <>
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://mojoglenn.lovable.app/neuromarketing-rennes" />
      ...
      <div className="min-h-screen bg-background">
          ...
          <section className="grid lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-20 items-center py-8 lg:py-12">
            <div>
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-8 tracking-tight leading-tight">
                Spécialiste <span className="highlight-box">neuromarketing</span> à Rennes : comprendre le cerveau de vos clients pour mieux vendre
              </h1>
              <div className="space-y-5 text-lg text-muted-foreground leading-relaxed max-w-2xl">
                <p>
                  Pourquoi certains messages marquent, convainquent, déclenchent l'achat — et d'autres tombent à plat ? La réponse n'est pas dans votre budget pub. Elle est dans le <strong className="text-foreground">cerveau de vos clients</strong>.
                </p>
                <p>
                  Consultant en stratégie de communication depuis <strong className="text-foreground">25 ans</strong> et spécialiste du neuromarketing basé à Rennes, j'aide les entreprises, les marques et les équipes commerciales en Bretagne — et partout en France — à comprendre les mécanismes des sciences cognitives pour améliorer leur communication, leurs ventes et leur impact.
                </p>
                <p>
                  Conférences, ateliers, formations ou consulting : on regarde ensemble ce qui fonctionne vraiment dans la tête de vos consommateurs, et ce qu'on peut faire de cette information.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-5 -left-5 bg-card border border-border/60 rounded-lg px-5 py-4 shadow-card max-w-xs">
                ...
                <p className="text-sm text-muted-foreground">
                  Bretagne, France entière, et en distanciel.
                </p>
              </div>
            </div>
          </section>
        ...
        <section className="py-24 lg:py-32 bg-card">
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <div className="space-y-5 text-lg text-muted-foreground leading-relaxed">
              <p>
                Le neuromarketing, ce n'est pas une mode ni un gadget. C'est l'application concrète des <strong className="text-foreground">sciences comportementales</strong> et des <strong className="text-foreground">sciences cognitives</strong> à votre communication, votre offre, votre discours commercial.
              </p>
              <p>
                Concrètement, ça répond à une question simple : comment fonctionne le cerveau de vos clients quand ils sont face à votre marque, votre produit, votre message ?
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-14">
              <div className="bg-background border border-border/60 rounded-lg p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  La plupart des entreprises communiquent sur la base d'intuitions, d'habitudes, ou de recettes marketing reprises sans être vérifiées (pyramide de Maslow, cerveau reptilien, « 95 % de décisions irrationnelles »…). Le problème ? Une bonne partie de ces recettes ne tiennent pas la route — et ça, je le sais, j'ai écrit un livre entier sur le sujet.
                </p>
              </div>
              <div className="bg-background border border-border/60 rounded-lg p-8">
                <h3 className="font-display text-xl md:text-2xl font-bold mb-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Mon rôle : faire le tri entre ce qui relève du mythe marketing et ce que les sciences cognitives confirment réellement, puis transformer ça en leviers concrets pour votre communication, votre site, vos argumentaires commerciaux ou vos campagnes.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mb-14">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Chaque entreprise a un problème commun : capter l'attention, créer de la confiance, et déclencher une décision. Les sciences comportementales donnent des clés très concrètes pour chacune de ces étapes.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  benefit: "Des messages publicitaires, des posts LinkedIn, des présentations commerciales qui sortent du lot.",
                ...
                },
                {
                  ...
                  benefit: "Des équipes commerciales plus à l'aise, des taux de conversion qui progressent durablement.",
                  link: { to: "/conferences#contact-conference", label: "Formation dédiée" },
                },
              ].map((card) => (
                <div
                  key={card.title}
                  className="bg-card border border-border/60 rounded-lg p-8 flex flex-col"
                >
        ...
        <section className="py-24 lg:py-32 bg-card">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mb-14">
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold mb-6 tracking-tight">
                Mes interventions : conférences, ateliers, formations et <span className="highlight-box">consulting</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Toutes mes interventions partent du même principe : rendre les sciences cognitives utiles, concrètes, et applicables immédiatement à votre activité.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {interventions.map((it) => (
                <div
                  key={it.title}
                  className="bg-background border border-border/60 rounded-lg p-8 flex flex-col"
                >
                  ...
                  {it.highlight && (
                    <p className="text-sm text-foreground font-semibold mb-6">👉 {it.highlight}</p>
                  )}
        ...
        <section className="py-24 lg:py-32">
          <div className="container mx-auto px-6 max-w-4xl">
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold mb-8 tracking-tight">
              Spécialiste neuromarketing à <span className="highlight-box">Rennes, en Bretagne</span>, et partout en France
            </h2>
            <div className="space-y-5 text-lg text-muted-foreground leading-relaxed">
              <p>
                Basé à Rennes, j'interviens prioritairement auprès des entreprises et marques bretonnes — <strong className="text-foreground">Rennes, Saint-Malo, Vannes, Brest, Lorient</strong>, et plus largement toute la région Bretagne — pour des conférences, ateliers et formations en neuromarketing en présentiel.
              </p>
              <p>
                Je me déplace également partout en France pour des interventions ponctuelles (conférences, séminaires, événements professionnels) ou pour des missions de consulting à distance.
              </p>
            </div>
            ...
            <div className="bg-card border border-border/60 rounded-lg p-8 mt-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Travailler avec un spécialiste basé localement, c'est plus de disponibilité, une meilleure compréhension du tissu économique régional, et souvent moins de contraintes logistiques pour organiser une intervention en présentiel.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 lg:py-32">
          <div className="container mx-auto px-6 max-w-4xl text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto mb-10">
              Conférence, atelier, formation ou consulting : quel que soit le format, l'objectif reste le même — comprendre comment fonctionne le cerveau de vos clients, et s'en servir pour améliorer votre communication et vendre plus, sans tomber dans le bullshit marketing.
            </p>
